  ...
  return (
    <div style={{ backgroundColor: "white", minHeight: "100vh" }}>
      ...
      >
        Tharun Baikani
        <span
          title="PM Accelerator is a US based company with a global reach premiering in AI learning and as a development hub, featuring award-winning AI products 
          and mentors from top-tier companies such as Google, Meta, Apple, and Nvidia. 
